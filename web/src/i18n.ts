...
const en: Record<string, string> = {
  ...
  // Import (Feature B)
  'import.title': 'Import from OpenAPI / HAR',
  'import.hint':
    'Turn an API spec or a recorded session into a scenario, then review and run it. Upload a file or paste the text below.',
  'import.file': 'Upload a file',
  'import.fileHint': 'OpenAPI (.json/.yaml) or a recording (.har).',
  'import.paste': 'Paste spec',
  'import.pastePlaceholder': 'Paste your OpenAPI or HAR document here…',
...
const ko: Record<string, string> = {
  ...
  // Import (Feature B)
  'import.title': 'OpenAPI / HAR에서 가져오기',
  'import.hint':
    'API 명세나 기록된 세션을 시나리오로 변환한 뒤 검토하고 실행하세요. 파일을 올리거나 아래에 텍스트를 붙여 넣으면 됩니다.',
  'import.file': '파일 올리기',
  'import.fileHint': 'OpenAPI(.json/.yaml) 또는 기록 파일(.har).',
  'import.paste': '명세 붙여넣기',
  'import.pastePlaceholder': 'OpenAPI 또는 HAR 문서를 여기에 붙여 넣으세요…',
  'import.format': '형식',
